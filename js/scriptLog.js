...
$(document).ready(function(){
    ...
    function CheckPage(){
        ...
        var res = url.split("https://student-info-system-portfolio.herokuapp.com/indexLog.php?page=");
        var result;
    ...
    $('#result').on("click", '.view', function(){
        ...
        $.ajax({
            url: 'php/ActivityLog/fetchLog.php',
            type: 'GET',
            data: {id: id},
            dataType: 'json',
            error: function() {
    ...
    function search_data(query, queryType, activityType){
        ...
        $.ajax({
            url: 'php/ActivityLog/searchLog.php',
            method:'POST',
    ...
    $('.restore').click(function(){
        ...
        //Poupulates Update/ Edit Form Inputs
        $.ajax({
            url: 'php/ActivityLog/fetchRestoreLog.php',
            type: 'GET',
            data: {id: id},
            dataType: 'json',
            error: function() {
            ...
            success: function(data) {
                ...
                $.ajax({
                    url: 'php/ActivityLog/insertLog.php',
                    type: 'POST',
