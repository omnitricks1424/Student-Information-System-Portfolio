...
$(document).ready(function(){
    ...
    function CheckPage(){
        ...
        var res = url.split("https://student-info-system-portfolio.herokuapp.com/index.php?page=");
        var result;
            ...
            success: function(data) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        window.location.href = "../php/CRUD/index.php";
                    }
                });
            }
        });
            ...
            $registerFormEdit.validate({
                ...
                submitHandler: function(form) {
                    ...
                    if(Changes()){
                        ...
                        window.location.href = "https://student-info-system-portfolio.herokuapp.com/index.php";
    ...
    function search_data(query, queryType){
        ...
        $.ajax({
            url: 'php/CRUD/search.php',
            method:'POST',
            data:{action:action, query:query, queryType:queryType, page:page},
            error: function() {
    ...
    function count_data(query, queryType){
        var action = "count";
        ...
        $.ajax({
            ...
            method:'POST',
            dataType:"json",
            data:{action:action, query:query, queryType:queryType, chartType:'gender'},
            error: function() {
        ...
        $.ajax({
            ...
            method:'POST',
            dataType:"json",
            data:{action:action, query:query, queryType:queryType, chartType:'city'},
            error: function() {
                alert('Count: Something is wrong');
            ...
            success:function(data) {
                ...
                graph.data.datasets[0].data = data.map(v => v.total);
                graph.data.labels = data.map(v => v.city);
                graph.data.datasets[0].backgroundColor = data.map(v => v.color);
                graph.update();
        ...
        $.ajax({
            ...
            method:'POST',
            dataType:"json",
            data:{action:action, query:query, queryType:queryType, chartType:'province'},
            error: function() {
                alert('Count: Something is wrong');
            ...
            success:function(data) {
                ...
                graph2.data.datasets[0].data = data.map(v => v.total);
                graph2.data.labels = data.map(v => v.province);
                graph2.data.datasets[0].backgroundColor = data.map(v => v.color);
                graph2.update();
	...
	$('.logout-btn').click(function(){
		$.ajax({
			url: 'php/LoginRegister/Logout.php',
			type: 'GET',
            dataType:"json",
			error: function() {
