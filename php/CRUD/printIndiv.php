<?php
    ...
    include_once('../../resources/library/FPDF/fpdf.php');
    ...
    $query = mysqli_query($conn, "SELECT * FROM `student-information` WHERE `id` = '$id'");
    ...
    while($data=mysqli_fetch_array($query)){
        ...
        $fileName = 'Student_Information_'  . $data['studentSurname'] . '_' . $data['studentFirstName'] . '_' . $data['studentMiddleInitial'] . '.';
